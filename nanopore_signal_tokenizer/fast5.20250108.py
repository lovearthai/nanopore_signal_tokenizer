...
from .nanopore import nanopore_normalize,nanopore_normalize_local,nanopore_normalize_hybrid,nanopore_repair_error, nanopore_filter
        ...
        try:
            with get_fast5_file(fast5_path, mode="r") as f5:
                ...
                for read in reads:
                    ...
                    if do_normalize:
                        signal, global_mad = nanopore_normalize_hybrid(signal_med, window_size=window_size)
                    else:
                        signal = signal_med
